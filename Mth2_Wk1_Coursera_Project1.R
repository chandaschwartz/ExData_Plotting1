...
if(!file.exists("~/Data Science Bootcamp/Exploratory Data Analysis/Project 1")){dir.create("~/Data Science Bootcamp/Exploratory Data Analysis/Project 1")}

# download & read the zip file
file_url <- "https://d396qusza40orc.cloudfront.net/exdata%2Fdata%2Fhousehold_power_consumption.zip"
download.file(file_url, destfile = "~/Data Science Bootcamp/Exploratory Data Analysis/Project 1/household_power_consumption.zip")
extracted <- unz("~/Data Science Bootcamp/Exploratory Data Analysis/Project 1/household_power_consumption.zip", filename = "household_power_consumption.txt")
