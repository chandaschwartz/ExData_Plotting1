...
png("~/Data Science Bootcamp/Exploratory Data Analysis/ExData_Plotting1/plot1.png", width=480, height=480)
hist(gap_num, col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
dev.off()
